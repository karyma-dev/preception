          ...
          <div class='modal-content'>
            ...
            <form id="#myform" className='contact'>
              <div className='contact-group'>
                ...
                <br />
                <input className='contact-input' onChange={ this.handleName } type='text' />
              </div>

              <div className='contact-group'>
                <label className='contact-label'>E-Mail</label>
                <br />
                <input className='contact-input' onChange={ this.handleEmail } type='email' />
              </div>

              <div className='contact-group'>
                <label className='contact-label'>Phone Number</label>
                <br />
                <input className='contact-input' onChange={ this.handlePhone } type='tel' />
              </div>

              <div className='check'>
                <label className='check-container'>
                  <input type='checkbox' name="investor" onChange={ this.handleType } />
                  <span className='check-title'>Investor</span>
                </label>

                <label className='check-container'>
                  <input type='checkbox' name="organization" onChange={ this.handleType } />
                  <span className='check-title'>Organization</span>
                </label>

                <label className='check-container'>
                  <input type='checkbox' name="athlete" onChange={ this.handleType } />
                  <span className='check-title'>Athlete</span>
                </label>

                <label className='check-container'>
                  <input type='checkbox' name="other" onChange={ this.handleType } />
